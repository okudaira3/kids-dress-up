...
const assetPath = (path: `assets/${string}`): string => `${import.meta.env.BASE_URL}${path}`;
    ...
    options: [
      {
        ...
        label: "おんなのこ",
        emoji: "🎀",
        cardImage: assetPath("assets/cards/person-girl.png"),
      },
      {
        id: "boy",
        label: "おとこのこ",
        emoji: "⭐",
        cardImage: assetPath("assets/cards/person-boy.png"),
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "tshirt",
        label: "Tシャツ",
        cardImage: assetPath("assets/cards/top-tshirt.png"),
        previewImage: assetPath("assets/preview/top-tshirt.png"),
      },
      {
        id: "shirt",
        label: "シャツ",
        cardImage: assetPath("assets/cards/top-shirt.png"),
        previewImage: assetPath("assets/preview/top-shirt.png"),
      },
      {
        id: "blouse",
        label: "ブラウス",
        cardImage: assetPath("assets/cards/top-blouse.png"),
        previewImage: assetPath("assets/preview/top-blouse.png"),
      },
      {
        id: "trainer",
        label: "トレーナー",
        cardImage: assetPath("assets/cards/top-trainer.png"),
        previewImage: assetPath("assets/preview/top-trainer.png"),
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "pants",
        label: "ズボン",
        cardImage: assetPath("assets/cards/bottom-pants.png"),
        previewImage: assetPath("assets/preview/bottom-pants.png"),
      },
      {
        id: "jeans",
        label: "ジーンズ",
        cardImage: assetPath("assets/cards/bottom-jeans.png"),
        previewImage: assetPath("assets/preview/bottom-jeans.png"),
      },
      {
        id: "shorts",
        label: "はんズボン",
        cardImage: assetPath("assets/cards/bottom-shorts.png"),
        previewImage: assetPath("assets/preview/bottom-shorts.png"),
      },
      {
        id: "skirt",
        label: "スカート",
        cardImage: assetPath("assets/cards/bottom-skirt.png"),
        previewImage: assetPath("assets/preview/bottom-skirt.png"),
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "backpack",
        label: "リュック",
        cardImage: assetPath("assets/cards/accessory-backpack.png"),
        previewImage: assetPath("assets/preview/accessory-backpack.png"),
      },
      {
        id: "glasses",
        label: "めがね",
        cardImage: assetPath("assets/cards/accessory-glasses.png"),
        previewImage: assetPath("assets/preview/accessory-glasses.png"),
      },
      {
        id: "hat",
        label: "ぼうし",
        cardImage: assetPath("assets/cards/accessory-hat.png"),
        previewImage: assetPath("assets/preview/accessory-hat.png"),
      },
    ],
  },
];
